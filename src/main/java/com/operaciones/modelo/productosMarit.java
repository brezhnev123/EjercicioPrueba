...
@Entity
@Table(name="productos_matrit")
public class productosMarit
{
    /************ [ Declaración de Variables Privadas ] ******************/
        ...
        */
        ...
        public productosMarit(){}

        public productosMarit(int id_producto, double id_cliente, String descripción, int cantidad, int peso, int id_bodega)
        {
